    ...
    <?php
      if($DOCUMENT_STATE_ERROR === false) {
        if($LOGIN_ACCOUNT_STATE == 1) {
          ...
          $invalid_domain_notice = $googleUserInfo->hd !==
            'utp.edu.co' ? '<i style="display:block;font-size:12px">(Correo no académico)</i>' : null
          ;
          ...
          echo <<<HTML
            ...
            <svg xmlns="http://www.w3.org/2000/svg" height="50px" viewBox="0 -960 960 960" width="50px" fill="#ec7063">
